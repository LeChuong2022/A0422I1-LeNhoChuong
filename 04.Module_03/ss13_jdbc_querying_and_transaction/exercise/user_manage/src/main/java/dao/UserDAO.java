...
public class UserDAO implements IUserDAO {
    ...
    private static final String UPDATE_USER_BY_ID_STORE = "call update_user_by_id(?,?,?,?);";
    ...
    public User getUserByIDStore(int id) {
        User user = null;
        try (Connection connection = getConnection();
             CallableStatement callableStatement = connection.prepareCall(SELECT_USER_BY_ID_STORE);) {
            callableStatement.setInt(1, id);
            ResultSet rs = callableStatement.executeQuery();
            while (rs.next()) {
                String name = rs.getString("name");
    ...
    @Override
    public boolean updateUserByIDStore(User user) {
        boolean rowUpdate = false;
        try (Connection connection = getConnection();
             CallableStatement callableStatement = connection.prepareCall(UPDATE_USER_BY_ID_STORE);) {
    ...
    @Override
    public boolean deleteUserByIDStore(int id) throws SQLException {
        boolean rowDelete;
        try (Connection connection = getConnection();
